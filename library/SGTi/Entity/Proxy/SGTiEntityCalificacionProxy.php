 ...
 */
class SGTiEntityCalificacionProxy extends \SGTi\Entity\Calificacion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'notaObtenida', 'observaciones');
    }
