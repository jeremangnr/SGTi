 ...
 */
class SGTiEntityDocenteProxy extends \SGTi\Entity\Docente implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'ci', 'nombre', 'apellido', 'fechaNac', 'telefono', 'celular', 'localidad', 'mail', 'usuario', 'cursos');
    }
